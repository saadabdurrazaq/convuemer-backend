            ...
            <div class="card card-outline card-info">
              <div class="card-body">
                  ...
                  <div class="col-md-6">
                    <nav class="navecation">
                      <ul id="navi" style="margin-top: 40px">
                        <li>
                          <router-link :to="{ name: 'sub-categories' }" class="menu" href="#"
                ...
                <div class="panel-body table-responsive" style="overflow: hidden">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="align-middle">
                          {{
                            sub_categories.indexOf(sub_category) + 1 + (currentPage - 1) * perPage
                          }}
                        </td>
                        <td class="align-middle">{{ sub_category.subcategory_name }}</td>
                        <td style="text-align: center; width: 30%">
                          <a
                            class="btn btn-success"
                            style="margin-right: 7px"
                            href=""
                            @click.prevent="restore(sub_category.id)"
                          >
                          ...
                          <a
                            ...
                            href=""
                            @click.prevent="forceDelete(sub_category.id)"
                          >
                  ...
                  <div v-if="isTrashedSubCatPagination">
                    ...
                    >
                      <pagination
                        ...
                        :per-page="perPage"
                        @paginate="getTrashedSubCategories"
                      />
                    </nav>
                  </div>
...
export default {
  ...
  // Declare sub_categories (as object), form (as /vform instance) and /isFormCreateBrandMode (as boolean defaulted to 'true') inside /data() { return {} }.
  data() {
    return {
      BASE_URL: BASE_URL,
      page: 1,
  ...
  methods: {
    ...
    loadSpecificPage() {
      if (this.defaultTrashedSubCatPagination === true) {
        this.isTrashedSubCatPagination = true;
        this.getTrashedSubCategories(this.page);
        console.log(`I am in getTrashedSubCat`);
      } 
        ...
        this.page = 1;
        this.getTrashedSubCategories(this.page);
        console.log(`No matching option. So, I am in getTrashedSubCat`);
      }
    },
    ...
    determineDefaultPage() {
      ...
      if (_.isEmpty(this.search) === false) {
        ...
        this.defaultTrashedSubCatPagination = false;
    ...
    // /getTrashedSubCategories() function. Function we use to get user list by calling api/sub_categories method GET.
    getTrashedSubCategories(page) {
      this.loading = true;
      this.isTrashedSubCatPagination = true;
      this.defaultTrashedSubCatPagination = true;
      this.defaultShowEntriesPagination = false;
      ...
      this.axios
        .get('api/staff/sub-categories/trash', {
          params: {
            page: page,
          },
        })
    ...
    showEntries(page) {
      ...
      this.defaultTrashedSubCatPagination = false;
      this.isTrashedSubCatPagination = false;
      this.defaultSearchPagination = false;
      this.isSearchPagination = false;
      ...
      this.axios
        .get('api/staff/sub-categories/trash?items=' + val, {
          params: {
            page: page,
          },
        })
    ...
    searchTrashedSubCategory: _.debounce(function (page) {
      if (_.isEmpty(this.search)) {
        ...
        this.axios
        .get('api/staff/sub-categories/trash/search/' + this.search, {
            params: {
              page: page,
            },
        })
      ...
      swal
        ...
        .then((result) => {
          ...
          if (result.value) {
            // request delete
            this.form
              .get('api/staff/sub-categories/restore/' + id, {})
              .then((response) => {
                this.detectRestore = true;
                this.highlightChangedRecord();
                this.determineDefaultPage();
                this.loadSpecificPage();
                this.title = 'Sub category restored successfully!';
    ...
    // /forceDelete() function. Function we use to delete user record by calling api/sub_categories/{id} method DELETE.
    forceDelete(id) {
      this.form.id = id;
      ...
      swal
        ...
        .then((result) => {
          if (result.value) {
            this.form
              .delete('api/staff/sub-categories/force-delete/' + id, {})
              .then((response) => {
                this.detectDelete = true;
                this.highlightChangedRecord();
                this.determineDefaultPage();
                this.loadSpecificPage();
                this.title = 'Sub category deleted successfully!';
                this.showSuccessMsg(response);
              })
              .catch(() => {
                // sweet alert fail
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/sub-categories/force-delete-multiple/ids=' + join_selected_values)
                  .then((response) => {
                    this.detectMultipleDelete = true;
                    this.highlightChangedRecord();
                    this.determineDefaultPage();
                    this.loadSpecificPage();
                    this.title = 'Sub category has been deleted successfully!';
                    this.showSuccessMsg(response);
                  })
                  .catch((error) => {
                    console.log(error.response.data);
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/sub-categories/restore-multiple/ids=' + multipleRestoredIds)
                  .then((response) => {
                    this.detectMultipleRestore = true;
                    this.highlightChangedRecord();
                    this.determineDefaultPage();
                    this.loadSpecificPage();
                    this.title = 'Sub category has been restored successfully!';
                    this.showSuccessMsg(response);
                  })
                  .catch((error) => {
                    console.log(error.response.data);
  ...
  created() {
    // Call /getTrashedSubCategories() function initially.
    this.getTrashedSubCategories();
  },
