            ...
            <div id="errMsg" class="box no-border errMsg">
                <div class="box-tools">
                    <p class="alert alert-warning alert-dismissible">
                        ...
                        If the weight below 1KG, round up the number to 1KG. If the minimum weight
                        is 1KG, and the overweight is 0.3 or above, round up the overweight to 1KG.
                        <button
                            type="button"
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8 sidebar">
                    ...
                    >
                        ...
                        <!-- shipping -->
                        <table style="margin-left: 15px; margin-right: 15px; margin-bottom: 25px">
                            <tr>
                                <td style="width: 80%">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            >
                                <div>
                                    ...
                                    <table>
                                        <tr>
                                            <td style="width: 60%; padding-bottom:10px;">{{ product[0].product_name }} x {{ quantity }}</td>
                                            <td style="width: 20%; text-align:right">Rp.{{ (product[0].price * quantity).toLocaleString() }}</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 60%;">Shipping cost</td>
                                            <td style="width: 20%; text-align:right">Rp.{{ shippingCost.toLocaleString() }}</td>
                                        </tr>
                                    </table>
                                    <hr class="class-1" />
