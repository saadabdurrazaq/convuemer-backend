              ...
              <div class="card-body">
                ...
                <div style="float: left; margin-left: 4px">
                  ...
                  >
                    ...
                    <option data-select2-id="38" value="trashMultiple">Delete</option>
                  </select>
                </div>
                ...
                <div class="panel-body table-responsive" style="overflow: hidden">
                  ...
                  <table class="table table-bordered table-hover dataTable" id="cat-table">
                    ...
                    <tbody>
                      ...
                      <tr :class="'data-' + order.id" v-for="order in orders" :key="order.id">
                        ...
                        <td class="align-middle">
                          {{ orders.indexOf(order) + 1 + (currentPage - 1) * perPage }}
                        </td>
              ...
              <div class="modal-content">
                ...
                <form @submit.prevent="isFormCreateSliderMode ? createSlider() : updateSlider()">
                    ...
                    <div class="form-group">
                      ...
                      <template v-if="form.products.length > 0">
                        <ul style="list-style-type: none">
                          <li v-for="product in form.products" :key="product.id">
                            <a
                              :href="
                                $router.resolve({
                                  name: 'product-show',
                      ...
                      <template v-if="form.variants_prod.length > 0">
                        <ul
                          ...
                          :style="
                            form.products.length > 0 && form.variants_prod.length > 0
                              ? 'margin-top:-13px;'
                              : ''
                          "
                        >
                          <li v-for="var_prod in form.variants_prod" :key="var_prod.id">
                            <a
                              :href="
                                $router.resolve({
                                  name: 'product-show',
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" v-show="isFormCreateSliderMode">
                      Save changes
                    </button>
                    <button type="submit" class="btn btn-primary" v-show="!isFormCreateSliderMode">
                      Update
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/orders/force-delete-multiple/ids=' + join_selected_values)
                  .then((response) => {
