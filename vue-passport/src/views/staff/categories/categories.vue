                ...
                <div class="row" style="margin-top: -20px">
                  <div class="col-md-4">
                    <nav class="navecation">
                      <ul id="navi" style="margin-top: 40px">
                        ...
                        <li>
                          <router-link :to="{ name: 'categories-trash' }" class="menu" href="#"
                  ...
                  <div class="col-md-8 text-right">
                    ...
                    <router-link
                      ...
                      class="btn btn-primary"
                      style="margin-top: 25px; margin-right: 7px"
                      ><i class="fas fa-list"></i> List of Sub Sub Categories</router-link
                    >
                  </div>
                </div>
                <hr />
                      ...
                      >
                        ...
                        <td v-if="category && category.sub_category.length > 0">
                          ...
                          >
                            ...
                            <a href="" @click.prevent="showAssignSubSubCatModal(subCategory)"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h5 v-show="isFormCreateCategoryMode" class="modal-title" id="exampleModalLabel">
                    Add new category
                  </h5>
                  <h5 v-show="isFormEditCategoryMode" class="modal-title" id="exampleModalLabel">
                    Update category
                  </h5>
                  <h5 v-show="isFormAssignCategoryMode" class="modal-title" id="exampleModalLabel">
                    Assign/Unassign category
                  </h5>
                  <h5 v-show="isFormAssignSubSubCat" class="modal-title" id="exampleModalLabel">
                ...
                >
                  <div class="modal-body">
                    ...
                    <div v-show="isFormCreateCategoryMode" class="form-group">
                      ...
                      <input
                        ...
                        id="category_icon"
                        class="form-control"
                        :class="{ 'is-invalid': form.errors.has('category_icon') }"
                      />
                      <small class="text-muted"
                        >End with a comma for single or multiple inputs. E.g: data1, data2,</small
                      >
                    ...
                    <div v-show="isFormAssignCategoryMode">
                      ...
                      <div class="icheck-primary">
                        ...
                        <label for="unassign"> &nbsp; Unassign all sub category/ies </label>
                      </div>
                      <small class="text-muted"
                        >Note:<br />
                        All relationship data also will be removed if you remove sub
                        category/ies</small
                      >
                    </div>
                    ...
                    <div v-show="isFormAssignSubSubCat" class="form-group">
                      ...
                      ></select>
                      <small class="text-muted"
                        >All trashed sub sub categories are not shown here!</small
                      >
                      <div
                        style="color: red"
                        class="errorIcon"
                    ...
                    <div v-show="isFormAssignSubSubCat">
                      ...
                      <small class="text-muted"
                        >Note:<br />
                        All relationship data also will be removed if you remove sub sub
                        category/ies</small
                      >
                    </div>
                  </div>
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" v-show="isFormEditCategoryMode">
                      Update
                    </button>
                    <button
                      type="submit"
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/categories/soft-delete-multiple/ids=' + join_selected_values)
                  .then((response) => {
