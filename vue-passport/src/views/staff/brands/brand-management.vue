                ...
                <div class="panel-body table-responsive" style="overflow: hidden">
                  ...
                  <table class="table table-bordered table-hover dataTable" id="cat-table">
                    ...
                    <tbody>
                      ...
                      <tr :class="'data-' + brand.id" v-for="brand in brands" :key="brand.id">
                        ...
                        <td class="align-middle">
                          {{ brands.indexOf(brand) + 1 + (currentPage - 1) * perPage }}
                        </td>
                        ...
                        <td style="text-align: center; width: 30%">
                          ...
                          <button :disabled="deleteBrandPermission === null" class="btn btn-warning" href="" @click.prevent="softDelete(brand.id)">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h5 v-show="isFormCreateBrandMode" class="modal-title" id="exampleModalLabel">
                    Add new brand
                  </h5>
                  <h5 v-show="!isFormCreateBrandMode" class="modal-title" id="exampleModalLabel">
                    Update brand
                ...
                <form @submit.prevent="isFormCreateBrandMode ? createBrand() : updateBrand()">
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <input type="file" id="brand_image" name="brand_image" @change="handleFile" />
                      <div
                        style="color: red"
                  ...
                  <div class="modal-footer">
                    ...
                    <button :disabled="createBrandPermission === null" type="submit" class="btn btn-primary" v-show="isFormCreateBrandMode">
                      Save changes
                    </button>
                    <button :disabled="updateBrandPermission === null" type="submit" class="btn btn-primary" v-show="!isFormCreateBrandMode">
                      Update
                    </button>
                  </div>
                </form>
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get(
                    'api/staff/brand-management/soft-delete-multiple/ids=' + join_selected_values
                  )
                  .then((response) => {
