      ...
      this.form
        ...
        .then((response) => {
          ...
          if (agreement[0] !== "agreement") {
            swal.fire({
              ...
              title: "Oops...",
              text:
                "Kamu harus menyatakan bahwa semua data yang kamu input benar adanya!",
        ...
        .catch((error) => {
          ...
          swal.fire({
            ...
            title: "Oops...",
            text:
              "Tidak boleh ada field yang kosong. Pastikan semua fields terisi dengan data yang valid!",
            footer: "<a href>Why do I have this issue?</a>",
          });
        })
        .finally(() => {
