            ...
            <div class="card card-outline card-info">
              <div class="card-body">
                <div class="row" style="margin-top: -20px">
                  ...
                  <div class="col-md-9 text-right">
                    ...
                    <router-link
                      ...
                      style="margin-top: 25px; margin-right: 7px"
                      ><i class="fas fa-list"></i> List of Categories</router-link
                    >
                    <router-link
                      ...
                      class="btn btn-primary"
                      style="margin-top: 25px; margin-right: 7px"
                      ><i class="fas fa-list"></i> List of Sub Categories</router-link
                    >
                  </div>
                </div>
                <hr />
                ...
                <div style="float: left; margin-left: 4px">
                  <select
                    class="form-control select2bs4 select2-accessible trash_multiple"
                    style="width: 130px"
                    data-select2-id=" 17"
                    tabindex="-1"
                    aria-hidden="true"
                  ...
                  >
                    ...
                    <option data-select2-id="38" value="trashMultiple">Trash</option>
                  </select>
                </div>
                ...
                <div class="panel-body table-responsive" style="overflow: hidden">
                  ...
                  <table class="table table-bordered table-hover dataTable" id="cat-table">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="align-middle">{{ sub_sub_category.subsubcategory_name }}</td>
                        <td style="text-align: center; width: 30%">
                          <a
                            class="btn btn-success"
                            style="margin-right: 7px"
                            href=""
                            @click.prevent="showModalSingleAssign(sub_sub_category)"
                          >
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h5 v-show="isFormEdit" class="modal-title" id="exampleModalLabel">
                    Update sub sub category
                  </h5>
                  <h5 v-show="isFormBulkAssign" class="modal-title" id="exampleModalLabel">
                    Bulk assign sub sub category
                  </h5>
                  <h5 v-show="isFormSingleAssign" class="modal-title" id="exampleModalLabel">
                ...
                >
                  <div class="modal-body">
                    ...
                    <div v-show="isFormCreate" class="form-group">
                      ...
                      <input
                        ...
                        class="form-control"
                        :class="{ 'is-invalid': form.errors.has('subsubcategory_name') }"
                      />
                      <small class="text-muted"
                        >End with a comma for single or multiple inputs. E.g: data1, data2,</small
                      >
                      <div
                        style="color: red"
                    ...
                    <!-- Bulk Assign form -->
                    <div v-show="isFormBulkAssign" class="form-group get-categories">
                      <label>Categories</label>
                      <select v-bind:name="form.category_id" id="category_id" class="form-control">
                        <option value="default" selected="true">Select Category</option>
                      </select>
                      <div
                        style="color: red"
                        class="errorIcon"
                    ...
                    <div v-show="isFormBulkAssign" class="form-group get-sub-categories">
                      ...
                      <select
                        ...
                        class="form-control"
                      >
                        <option value="default" id="default-subcat" selected="true">
                          Select Sub Category
                        </option>
                      </select>
                      <div
                    ...
                    <div v-show="isFormBulkAssign" class="form-group">
                      ...
                      ></select>
                      <small class="text-muted"
                        >All pre assigned items will be appeared inside this input fields</small
                      >
                      <div
                        style="color: red"
                        class="errorIcon"
                    ...
                    <!-- Single Assign form -->
                    <div v-show="isFormSingleAssign" class="form-group get-categories2">
                      <label>Categories</label>
                      <select v-bind:name="form.category_id" id="category_id2" class="form-control">
                        <option value="default" selected="true">Select Category</option>
                      </select>
                      <div
                        style="color: red"
                    ...
                    <div v-show="isFormSingleAssign" class="form-group get-sub-categories2">
                      <label>Sub Categories</label>
                      <select
                        v-bind:name="form.subcategory_id"
                        id="subcategory_id2"
                    ...
                    <div v-show="isFormSingleAssign">
                      ...
                      <div class="col-8">
                        <div class="icheck-primary">
                          <input type="checkbox" name="unassign" value="unassign" id="unassign" />
                          <label for="unassign"> &nbsp; Unassign sub sub category </label>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" v-show="isFormEdit">
                      Update
                    </button>
                    <button
                      type="submit"
...
export default {
  ...
  methods: {
        ...
        .then((response) => {
          ...
          if (allRelatedSubCategories !== undefined) {
            allRelatedSubCategories.forEach(function (subCategory) {
              var option = new Option(subCategory.subcategory_name, subCategory.id, true, true);
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              subCategories.forEach(function (category) {
                var option = new Option(category.subcategory_name, category.id, true, true);
                // Bulk assign form
    ...
    fillAndLoadSubSubCat() {
      ...
      $('#subcategory_id').on('change', function () {
        ...
        if (subcategory_id !== 'default') {
          $.ajax({
            url:
              `${BASE_URL}/api/staff/sub-sub-categories/get-sub-sub-categories/` + subcategory_id,
            type: 'GET',
            dataType: 'json',
            beforeSend: function (xhr) {
              xhr.setRequestHeader('Authorization', `Bearer ${token}`);
    ...
    highlightChangedRecord() { 
      if (this.detectUpdate === true || this.detectSingleAssign === true || this.detectTrash === true) {
        $(".data-" + this.form.id)
            .toggleClass('highlight')
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get(
                    'api/staff/sub-sub-categories/soft-delete-multiple/ids=' + join_selected_values
                  )
                  .then((response) => {
                    ...
                    this.determineDefaultPage();
                    this.loadSpecificPage();
                    this.title = 'Sub sub category/ies has been trashed successfully!';
                    this.showSuccessMsg(response);
                  })
                  .catch((error) => {
                    console.log(error.response.data);
