        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li>
                <router-link :to="{name: 'user-login'}" class="nav-link" href="#"><i class="icon fa fa-lock"></i>Login</router-link>
              </li>
            </ul>
          </div>
          <!-- /.cnt-account -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
            <!-- ============================================================= LOGO ============================================================= -->
            <div class="logo">
              <a href="home.html"> <img :src="require('@/assets/frontend/images/logo.png')" alt="logo" /> </a>
            </div>
            <!-- /.logo -->
            <!-- ============================================================= LOGO : END ============================================================= -->
          </div>
                ...
                <ul class="nav navbar-nav">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                              <img
                                ...
                                :src="require('@/assets/frontend/images/banners/top-menu-banner.jpg')"
                                alt=""
                              />
                            </div>
                            <!-- /.yamm-content -->
                  ...
                  <li class="dropdown mega-menu">
                    <a
                      ...
                      class="dropdown-toggle"
                      data-toggle="dropdown"
                      >Electronics <span class="menu-label hot-menu hidden-xs">hot</span>
                    </a>
                    <ul class="dropdown-menu container">
                      <li>
                        <div class="yamm-content">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                              <a href="#"
                                ><img alt="" :src="require('@/assets/frontend/images/banners/banner-side.png')"
                              /></a>
                            </div>
                          </div>
                          <!-- /.row -->
