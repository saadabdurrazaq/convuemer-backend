                                            ...
                                            >
                                                ...
                                                <td style="text-align: center; width: 30%">
                                                    <a
                                                        ...
                                                        href=""
                                                        @click.prevent="restore(slider.id)"
                                                    >
                                                    ...
                                                    <a
                                                        ...
                                                        href=""
                                                        @click.prevent="forceDelete(slider.id)"
                                                    >
...
export default {
    ...
    methods: {
        ...
        loadSpecificPage() {
            if (this.defaultslidersPagination === true) {
                ...
                this.getTrashedData(this.page);
                console.log(`I am in getTrashedData`);
                ...
                this.page = 1;
                this.getTrashedData(this.page);
                console.log(`No matching option. So, I am in getTrashedData`);
            }
        },
        ...
        // /getTrashedData() function. Function we use to get user list by calling api/sliders method GET.
        getTrashedData(page) {
            this.loading = true;
            this.isslidersPagination = true;
        ...
        showEntries(page) {
            ...
            this.axios
                .get('api/staff/sliders/trash?items=' + val, {
                    params: {
                        page: page,
                    },
                })
        ...
        searchslider: _.debounce(function (page) {
            if (_.isEmpty(this.search)) {
                ...
                this.axios
                    .get('api/staff/sliders/trash/search/' + this.search, {
                        params: {
                            page: page,
                        },
                    })
        ...
        // /forceDelete() function. Function we use to delete user record by calling api/sliders/{id} method DELETE.
        forceDelete(id) {
            this.form.id = id;
            ...
            swal.fire({
                ...
                if (result.value) {
                    // request delete
                    this.form
                        .delete('api/staff/sliders/force-delete/' + id, {})
                        .then((response) => {
                            this.detectDelete = true;
                            this.highlightChangedRecord();
                            this.determineDefaultPage();
                            this.loadSpecificPage();
                            this.title = 'slider deleted successfully!';
                            this.showSuccessMsg(response);
                        })
                        .catch(() => {
                            // sweet alert fail
                ...
                if (allVals.length <= 0) {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            this.axios
                                .get(
                                    'api/staff/sliders/force-delete-multiple/ids=' +
                                ...
                                .then((response) => {
                                    ...
                                    this.determineDefaultPage();
                                    this.loadSpecificPage();
                                    this.title = 'slider/s has been deleted successfully!';
                                    this.showSuccessMsg(response);
                                })
                                .catch((error) => {
                                    console.log(error.response.data);
                ...
                if (multipleVals.length <= 0) {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            this.axios
                                .get(
                                    'api/staff/sliders/restore-multiple/ids=' + multipleRestoredIds
                                )
                                .then((response) => {
                                    ...
                                    this.determineDefaultPage();
                                    this.loadSpecificPage();
                                    this.title = 'slider/s has been restored successfully!';
                                    this.showSuccessMsg(response);
                                })
                                .catch((error) => {
                                    console.log(error.response.data);
    ...
    created() {
        // Call /getTrashedData() function initially.
        this.getTrashedData();
    },
