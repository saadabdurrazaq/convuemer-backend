                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            <input
                                                                ...
                                                                :class="
                                                                    'product_weight_variant_' +
                                                                    variantVal.id
                                                                "
                                                                type="text"
                                                                class="
                                                                    form-control
                                                                    product_weight_variant
                                                                "
                                                                required
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input
                                                        ...
                                                        :class="{
                                                            'is-invalid':
                                                                form.errors.has('product_weight'),
                                                        }"
                                                        type="text"
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div
                                                            ...
                                                            v-html="
                                                                form.errors.get('product_length')
                                                            "
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div
                                                            ...
                                                            v-html="
                                                                form.errors.get('product_height')
                                                            "
                                                        />
                                                    </div>
                                                </div>
