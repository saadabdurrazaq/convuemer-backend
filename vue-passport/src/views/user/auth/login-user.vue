        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 sign-in">
            <div class="col-md-12 col-sm-12">
              ...
              <form role="form" name="loginForm" class="register-form outer-top-xs" @submit.prevent="login">
                ...
                <button type="submit" @click="submit" class="btn-upper btn btn-primary checkout-page-button">
                  <div id="loadingCircle" style="display:none;right:5%" class="lds-ring"><div></div><div></div><div></div><div></div></div>
