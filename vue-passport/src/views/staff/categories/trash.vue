                                    ...
                                    <table class="table table-bordered table-hover dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                <td
                                                    v-if="
                                                        category && category.sub_category.length > 0
                                                    "
                                                >
                                                    <div
                                                    ...
                                                    >
                                                        ...
                                                        <a
                                                            href=""
                                                            @click.prevent="
                                                                showSubSubCatModal(subCategory)
                                                            "
                                                            >({{
                                                ...
                                                <td
                                                    ...
                                                    style="color: #606770"
                                                >
                                                    No related sub and sub-sub category for this
                                                    category.
                                                </td>
                ...
                if (allVals.length <= 0) {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            this.axios
                                .get(
                                    'api/staff/categories/force-delete-multiple/ids=' +
                ...
                if (multipleVals.length <= 0) {
                    ...
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            this.axios
                                .get(
                                    'api/staff/categories/restore-multiple/ids=' +
                                        multipleRestoredIds
                                )
                                .then((response) => {
