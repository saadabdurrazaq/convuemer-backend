<template>
  ...
  <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
    ...
    <div class="thumbnails-wrapper">
      <!-- agile here -->
      <agile class="thumbnails" ref="thumbnails" :options="options" :key="productSliders.length">
        <div class="slide slide--thumbniail" v-for="slider in productSliders" :key="slider.id">
          <div class="product-image">
            <div class="image" :set="(images = JSON.parse(slider.images))" :key="images[0].key">
               <img :src="`${BASE_URL}/storage/app/public/products/${images[0].caption}`" alt="" />
            </div>
            <!-- /.image -->
          </div>
          <!-- /.product-image --> 
