  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form class="user" id="loginForm" name="loginForm" @submit.prevent="login">
          ...
          <div class="row">
            ...
            <div class="col-4">
              <button type="submit" @click="submit" class="btn btn-primary btn-block">
                <div id="loadingCircle" style="display: none; right: 5%" class="lds-ring">
                  <div></div>
                  <div></div>
                  <div></div>
                  <div></div>
        ...
        <router-link to="/register" class="text-center">Create an Account!</router-link><br />
        <router-link to="/forget" class="text-center">Forget Password</router-link><br />
