                          ...
                          <tr v-for="variantVal in form.variants_prod" :key="variantVal.id">
                            ...
                            <td>
                              <input
                                ...
                                type="text"
                                :class="'variant_available_stock_' + variantVal.id"
                      ...
                      <div class="col-md-7">
                        <div class="form-group">
                          <select
                            ...
                            style="width: 120px"
                          >
                            <option :value="''" disabled :selected="form.metric_mass === ''">Select Metric Mass</option>
        ...
        .on('tokenfield:createdtoken', function () {
          ...
          self.form.variants_prod.forEach((data) => {
            ...
            setTimeout(function () {
              ...
              self.disableRightClickAndLongPress('variant_available_stock_' + data.id);
            }, 100);
          });
        })
    ...
    fileInputVariants(id) {
      ...
      $('.images' + id)
        ...
        .on('filedeleted', function (event, key) {
          ...
          var filteredRes = getDataFileInfo.filter((item) => !singleRemoveFileInfo.includes(item));
