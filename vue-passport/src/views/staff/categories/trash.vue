    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-info">
              <div class="card-body">
                  ...
                  <div class="col-md-6">
                    <nav class="navecation">
                      <ul id="navi" style="margin-top: 40px">
                        <li>
                          <router-link :to="{ name: 'categories' }" class="menu" href="#"
                ...
                <div style="float: left; padding-top: 3px; padding-left: 4px; padding-right: 10px">
                  entries
                </div>
                <div style="float: left; margin-left: 4px">
                  <select
                    class="form-control select2bs4 select2-accessible bulk_actions"
                    style="width: 130px"
                    data-select2-id=" 17"
                    tabindex="-1"
                    aria-hidden="true"
                  ...
                  >
                    ...
                    <option data-select2-id="38" value="restoreMultiple">Restore</option>
                    <option data-select2-id="38" value="deleteMultiple">Delete</option>
                  </select>
                </div>
                <div style="float: right">
                  <form action="">
                    <div class="input-group input-group-sm" style="width: 260px">
                      <input
                        type="text"
                        @keyup="searchTrashedCategory"
                        placeholder="Search categories or sub categories"
                        v-model="search"
                        class="form-control float-right"
                      />
                      <div class="input-group-append">
                        <button type="submit" value="Filter" class="btn btn-default">
                ...
                <div class="panel-body table-responsive" style="overflow: hidden">
                    ...
                    <thead>
                      <tr>
                        <th style="text-align: center">
                          <input type="checkbox" id="select-multiple" @click="selectMultiple()" />
                        </th>
                        <th>No</th>
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="align-middle">
                          {{ categories.indexOf(category) + 1 + (currentPage - 1) * perPage }}
                        </td>
                        ...
                        <td v-if="category && category.sub_category.length > 0">
                          ...
                          >
                            ...
                            <a href="" @click.prevent="showSubSubCatModal(subCategory)"
                              >({{ subCategory.sub_sub_category.length }})</a
                            >,
                          </div>
                        </td>
                        <td v-if="category.sub_category.length === 0" style="color: #606770">
                        ...
                        <td style="text-align: center; width: 30%">
                          <a
                            ...
                            href=""
                            @click.prevent="restore(category.id)"
                          >
                  ...
                  <div v-if="isTrashedCatPagination">
                  ...
                  <div v-if="isSearchPagination">
                    ...
                    >
                      <pagination
                        ...
                        :records="totalRecords"
                        :per-page="perPage"
                        @paginate="searchTrashedCategory"
                      />
                    </nav>
                  </div>
                </div>
          ...
          <!-- Modal containing dynamic form for displaying details of data. -->
          <div
            class="modal fade"
            id="exampleModal"
            tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 v-show="isShowSubSubCatModal" class="modal-title" id="exampleModalLabel">
                    Detail of sub category and sub sub category
                  </h5>
                  <button
                    type="button"
                ...
                <div class="modal-body">
                  ...
                  <div v-if="loadingForm" style="position: absolute; top: 20%; left: 40%">
                    <div class="lds-facebook">
                      <div></div>
                      <div></div>
                      <div></div>
                  ...
                  <div v-show="isShowSubSubCatModal" class="form-group">
...
export default {
  ...
  // Declare categories (as object), form (as /vform instance) and /isFormCreateBrandMode (as boolean defaulted to 'true') inside /data() { return {} }.
  data() {
    return {
      BASE_URL: BASE_URL,
      page: 1,
      ...
      loading: false,
      loadingForm: false,
      isTrashedCatPagination: false,
      isShowEntriesPagination: false,
      isSearchPagination: false,
      defaultTrashedCatPagination: false,
  ...
  methods: {
    ...
    loadSpecificPage() {
      if (this.defaultTrashedCatPagination === true) {
        this.isTrashedCatPagination = true;
        this.getTrashedCategories(this.page);
        console.log(`I am in getTrashedCat`);
        ...
        this.searchTrashedCategory(); // the page is not defined because we should return it to page 1.
        console.log(`I am in search page`);
      } else {
        this.page = 1;
        this.getTrashedCategories(this.page);
        console.log(`No matching option. So, I am in getTrashedCat`);
      }
    },
    ...
    determineDefaultPage() {
      ...
      if (_.isEmpty(this.search) === false) {
        ...
        this.defaultTrashedCatPagination = false;
    ...
    // /getTrashedCategories() function. Function we use to get user list by calling api/categories method GET.
    getTrashedCategories(page) {
      this.loading = true;
      this.isTrashedCatPagination = true;
      this.defaultTrashedCatPagination = true;
      this.defaultShowEntriesPagination = false;
      ...
      this.axios
        .get('api/staff/categories/trash', {
          params: {
            page: page,
          },
        })
    ...
    showEntries(page) {
      ...
      this.defaultTrashedCatPagination = false;
      this.isTrashedCatPagination = false;
      this.defaultSearchPagination = false;
      this.isSearchPagination = false;
      ...
      this.axios
        .get('api/staff/categories/trash?items=' + val, {
          params: {
            page: page,
          },
        })
    ...
    searchTrashedCategory: _.debounce(function (page) {
      if (_.isEmpty(this.search)) {
        ...
        this.axios
          .get('api/staff/categories/trash/search/' + this.search, {
            params: {
              page: page,
            },
          })
        ...
        .then((response) => {
          ...
          for (let i = 0; i < subCategory.length; i++) {
            ...
            subSubCategories.forEach(function (subSubCategory) {
              $('.sub_sub_cat').append(subSubCategory.subsubcategory_name + ', ');
            });
          }
    ...
    showSubSubCatModal(subCat) {
      this.isShowSubSubCatModal = true;
    ...
    restore(id) {
      ...
      swal
        ...
        .then((result) => {
          if (result.value) {
            this.form
              .get('api/staff/categories/restore/' + id, {})
              .then((response) => {
                this.detectRestore = true;
                this.highlightChangedRecord();
                this.determineDefaultPage();
                this.loadSpecificPage();
                this.title = 'Category restored successfully!';
    ...
    // /forceDelete() function. Function we use to delete user record by calling api/categories/{id} method DELETE.
    forceDelete(id) {
      this.form.id = id;
      ...
      swal
        ...
        .then((result) => {
          if (result.value) {
            this.form
              .delete('api/staff/categories/force-delete/' + id, {})
              .then((response) => {
                this.detectDelete = true;
                this.highlightChangedRecord();
                this.determineDefaultPage();
                this.loadSpecificPage();
                this.title = 'Category deleted successfully!';
                this.showSuccessMsg(response);
              })
              .catch(() => {
                // sweet alert fail
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/categories/force-delete-multiple/ids=' + join_selected_values)
                  .then((response) => {
                    this.detectMultipleDelete = true;
                    this.highlightChangedRecord();
                    this.determineDefaultPage();
                    this.loadSpecificPage();
                    this.title = 'Category has been deleted successfully!';
                    this.showSuccessMsg(response);
                  })
                  .catch((error) => {
                    console.log(error.response.data);
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/categories/restore-multiple/ids=' + multipleRestoredIds)
                  .then((response) => {
                    this.detectMultipleRestore = true;
                    this.highlightChangedRecord();
                    this.determineDefaultPage();
                    this.loadSpecificPage();
                    this.title = 'Category has been restored successfully!';
                    this.showSuccessMsg(response);
                  })
                  .catch((error) => {
                    console.log(error.response.data);
  ...
  created() {
    // Call /getTrashedCategories() function initially.
    this.getTrashedCategories();
  },
