                  ...
                  <div class="col-md-4">
                    <nav class="navecation">
                      <ul id="navi" style="margin-top: 40px">
                        ...
                        <li>
                          <router-link :to="{ name: 'products-trash' }" class="menu" href="#"
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="align-middle">
                          {{ products.indexOf(product) + 1 + (currentPage - 1) * perPage }}
                        </td>
                        <td v-if="product.images !== 'null'" class="align-middle">
                          <img
                        ...
                        <td v-if="product.status === 'Active'" class="align-middle">
                        ...
                        <td v-if="product.status === 'Inactive'" class="align-middle">
                          <div class="form-group">
                            <input
                              type="checkbox"
                              name="permission[]"
          ...
          swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.axios
                  .get('api/staff/products/soft-delete-multiple/ids=' + join_selected_values)
                  .then((response) => {
